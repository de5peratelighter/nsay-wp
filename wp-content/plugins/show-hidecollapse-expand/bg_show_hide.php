...
function bg_show_hide_shortcode($attr, $content = null) {
	...
	if ( $a["view"] == 'link') {
		$showmore_btn = "<a id='bg-showmore-action-$bg_uniq_id' class='bg-showmore-plg-link $bg_btn_icon_class' $bg_onclick style=\" color:" . $bg_text_color . ";\" href='#'>" . $bg_expand_text . "</a>";
		$bg_hidden_content_start = "<p style='$bg_inline_css'>";
