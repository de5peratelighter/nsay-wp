    ...
    <div class="col-sm-6">
        <article>
            ...
            <ul class="list-inline post-info">
                <li><a href="<?php echo get_day_link(get_post_time('Y'), get_post_time('m'), get_post_time('d')); ?>"><i class="fa fa-calendar"></i> &nbsp; <?php echo get_the_date(get_option('date_format'));?></a></li>
                <?php if (get_comments_number( get_the_ID() )): ?>
                	<li class="comments-number"><a href=""><i class="fa fa-comments"></i> &nbsp; <?php comments_popup_link(false, false, false);?></a></li>
                <?php endif; ?>
            </ul>
            ...
            <div class="tag-button">
                ...
                <span class="read-more pull-right">
                    <a href="<?php the_permalink();?>" class="btn btn-theme"><?php _e('Read More ','archibuk') ?><i class="fa fa-angle-double-right"></i> </a>
                </span>
            </div>
